...
class Lorentz(LorentzOri):
    ...
    def projx_poincare(self, x: torch.Tensor, *, dim=-1) -> torch.Tensor:
        """Project vector to Poincare ball"""
        return math.project_poincare(x, eps=1e-6, dim=dim)
    ...
    def inner_matmul(
        ...
        *,
        ...
        return math._inner_matmul(x, y, keepdim=keepdim)
